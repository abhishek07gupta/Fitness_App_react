...
function SeachExercise() {
    ...
    useEffect(()=>{
        const fetchExerciseData = async()=>{ 
            const dataForCategory = await fetchData('https://exercisedb.p.rapidapi.com/exercises/bodyPartList',options)
            setBodyParts(['All',...dataForCategory])
    } 
